...
if(isset($_GET['update']))
{
	...
	{
		$type = $data->newsTypeName;
	}
	
	$page_title = 'Update news type';
                ...
                <section class="content">
                    ...
                    <div class="row">
                    	<div class="col-xs-4">
                            ...
                            <div class="box">
                                ...
                                <?php
                                    ...
                                    {
                                        $controller->postnewstype($url, $table);
                                        
                                        $user_columns = "user, eventdetails";
                                        $user_values = "'$uid', 'Added news type'";
                                    ...
                                    {
                                        $controller->updatenewstype($updateid, $url, $primary_key, $table);
                                        
                                        $user_columns = "user, eventdetails";
                                        $user_values = "'$uid', 'Updated news type'";
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="type" id="type" placeholder="News type" class="form-control" value="<?php echo $type;?>">
                                        </div>
                                        <hr>
                                        <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            ...
                            <div class="box">
                            <div class="box-header">
                            <h3 class="box-title">News types</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                            <?php
                            ...
                            <table id="example1" class="table table-bordered table-striped bulk_action">
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" class="table_records flat" name="ids[]" value="<?php echo $id;?>" title="<?php echo $data->newsTypeName;?>"></td>
                                    <td><?php echo $count;?></td>
                                    <td><?php echo $data->newsTypeName;?></td>
