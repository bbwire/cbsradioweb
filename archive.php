                ...
                <section class="content">
                    ...
                    <div class="nav-tabs-custom">
                                    ...
                                    <?php
                                        ...
                                        /*if(isset($_POST['approvemulti'])){
                                            ...
                                            if(isset($_POST['ids']))
                                            {
                                                ...
                                                {
                                                    $value = $_POST['ids'][$i];
                                                    $controller->approvemultiple($table, $primary_key, $value, $url);
                                                }
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['from']) and isset($_GET['to']))
                                              ...
                                              if($mfrom != '' and $mto != '')
                                              {
                                                  $sql = "SELECT * FROM $table where dateReported between '$mfrom' and '$mto'";
                                              }
                                              /*else if($mmonth != '')
                                              {
                                                    ...
                                                    <div class="row">
                                                        <form action="" class="form-horizontal form-label-left" id="demo-form2" data-parsley-validate>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <label class="control-label" for="from">From <span class="required">*</span>
                                                                </label>
                                                                 <input class="form-control" name="from" placeholder="From" id="start_date" type="text" value="<?php echo $mfrom;?>">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                
                                                                <label class="control-label" for="to">To <span class="required">*</span>
                                                                </label>
                                                                 <input class="form-control" name="to" placeholder="To" id="end_date" type="text" value="<?php echo $mto;?>">
                                                            </div>
                                      ...
                                      <table id="example1" class="table table-bordered table-striped bulk_action">
                                        ...
                                        <?php
                                        $date = date("Y-m-d");
                                        $datas = $controller->getcustomdata("select * from ".$table." order by id desc");
                                        ...
                                        <tr>
                                          ...
                                          <td><a href="?from=<?php echo $mfrom;?>&to=<?php echo $mto;?>&detail=<?php echo $id;?>"><?php echo $data->title;?></a></td>
                                      ...
                                      <!--<div class="clearfix"></div>
                                            <hr>
                                            <button type="submit" class="btn btn-success btn-flat" name="approvemulti" id="approve_multiple"><i class="fa fa-check"></i> Approve selected news</button>
                                            <button type="submit" class="btn btn-danger btn-flat pull-right" name="deletemulti" id="delete_multiple"><i class="fa fa-trash"></i> Delete multiple Records</button>-->
                        ...
                        <div class="form-group">
                            ...
                            <h2>Public news archive here</h2>
                            </div>
                            <!-- /.tab-pane -->
                            </div>
                            <!-- /.tab-content -->
