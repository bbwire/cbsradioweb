...
define(['modernizr', 'screenfull', 'config', 'underscore', 'jstorage'], function (Modernizr, Screenfull, Config, _) {
        ...
        return{
            ...
            isVideoFormatSupported : function (format) {
                if (format === 'mp4') format = 'h264';
                return Modernizr.video[format] === 'probably';
            },

            isAudioFormatSupported : function (format) {
            ...
            removeProjectFromLocalStorage : function (id) {
                "use strict";
            ...
            getAvailableProjectsFromLocalStorage : function () {
                'use strict';
