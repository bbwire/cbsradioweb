  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">User privilages</li>
      </ol>
    </section>
            ...
            <div class="box-body">
				...
				<form action="" method="post" enctype="multipart/form-data">
                	<div class="item form-group">
					  ...
					  <select name="type" class="options form-control" required id="type">
                  ...
                  <div class="item form-group">
                    <div class="privils">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <label>All modules (only for chief admin)</label>
                        </div>
                        <?php
                        ...
                        <?php
                        $setts = array('Tasks', 'News types', 'Stations', 'Privilages', 'Add user type', 'Configuration settings', 'Backup database');
                        ...
                        <?php
                        $empps = array('Incoming news', 'News highlights', 'To be aired', 'Users', 'Reorder news', 'Trashed news', 'Assign time', 'Assign tasks', 'User log', 'Archive', 'Capture news');
