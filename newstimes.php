                ...
                <section class="content">
                    ...
                    <div class="row">
                    	<div class="col-xs-4">
                            ...
                            <div class="box">
                                ...
                                <?php
                                    ...
                                    {
                                        $controller->posttime($url, $table);
                                    }
                                    
                                    if(isset($_POST['update']))
                                    {
                                        $controller->updatetime($updateid, $url, $primary_key, $table);
                                    }
                                    ?>
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="timelabel">Time</label>
                                            <input type="text" name="timelabel" id="timelabels" placeholder="Time" class="form-control starttime" value="<?php echo $timelabel;?>">
                                        </div>
                                        <hr>
                                        <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            ...
                            <div class="box">
                            <div class="box-header">
                            <h3 class="box-title">News times</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                            <?php
