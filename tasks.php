                    	...
                    	<div class="col-xs-4">
                            ...
                            <div class="box">
                                ...
                                <?php
                                    ...
                                    {
                                        $controller->posttask($url, $table);
                                    }
                                    
                                    if(isset($_POST['update']))
                                    {
                                        $controller->updatetask($updateid, $url, $primary_key, $table);
                                    }
                                    ?>
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="title">Title</label>
                                            <input type="text" name="title" id="title" placeholder="Title" class="form-control" value="<?php echo $title;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="deadline">Deadline</label>
                                            <input type="text" name="deadline" id="deadline" placeholder="Deadline" class="form-control" value="<?php echo $deadline;?>">
                                        </div>
                                        <hr>
                                        <div class="form-group">
