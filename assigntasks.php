                    	...
                    	<div class="col-xs-4">
                            ...
                            <div class="box">
                                ...
                                <?php
                                    ...
                                    {
                                        $controller->assigntask($url, $table);
                                    }
                                    
                                    if(isset($_POST['update']))
                                    {
                                        $controller->updateassignedtask($updateid, $url, $primary_key, $table);
                                    }
                                    ?>
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <?php
                                            $tasks = $controller->getdata("tasks", "id", "asc");
                                            ?>
                                            <label class="control-label" for="task">Task <span class="required">*</span>
                                            </label>
                                        <select name="task" class="select2 form-control" required id="task">
                                            <option value="">Select Task</option>
                                            <?php
                                            foreach($tasks as $tas)
                                            {
                                                ?>
                                                <option value="<?php echo $tas->id;?>" <?php if($task == $tas->id) echo 'selected'; ?>><?php echo $tas->title;?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="from" id="start_date" placeholder="From" class="form-control" value="<?php echo $from;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="end_date">To</label>
                                            <input type="text" name="to" id="end_date" placeholder="To" class="form-control" value="<?php echo $to;?>">
                                        </div>
                                        <!--<div class="form-group">
                                            <div class="row">
                                            <?php
                                            ...
                                            {
                                                if(in_array($task->taskId, $taskarray))
                                                {
                                                    ?>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <label><input type="checkbox" class="flat" name="tasks[]" value="<?php echo $task->taskId;?>" checked> <?php echo $task->title;?></label>
                                                    </div>
                                                    <?php
                                                }else
                                                {
                                                    ?>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <label><input type="checkbox" class="flat" name="tasks[]" value="<?php echo $task->taskId;?>"> <?php echo $task->title;?></label>
                                                    </div>
                                                    <?php
                                                }
                                            }
                        ...
                        <div class="col-xs-8">
                            ...
                            <table id="example1" class="table table-bordered table-striped bulk_action">
                                ...
                                foreach($datas as $data)
                                {
                                    ...
                                    $get_task = $controller->getindividual("tasks", "id", $task);
                                    foreach($get_task as $tas)
                                    {
                                        $tasknam = $tas->title;
                                    }
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" class="table_records flat-red" name="ids[]" value="<?php echo $id;?>"></td>
                                    <td><?php echo $count;?></td>
                                    <td><?php echo $usernam;?></td>
                                    <td><?php echo $tasknam;?></td>
                                    <td><?php echo $from;?></td>
                                    <td><?php echo $to;?></td>
